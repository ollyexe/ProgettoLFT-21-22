public class Instruction {  // contiene gli opcode delle istruzioni che possiamo utilizzare
    OpCode opCode;
    int operand;
    ...
    public String toJasmin () { //metodo che inserisce i comandi per l'interprete Jasmin che successivamente verranno trasformati in un file eseguibile java
        String temp="";
        switch (opCode) {
